                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-8 offset-sm-2 offset-md-0">
                                                    <div class="product home_item_large">
                                                        ...
                                                        <div class="product_image"><img src="{{asset('images/home_2.jpg')}}"
                                                                alt=""></div>
                                                            ...
                                                            <div class="product_buttons">
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div>
                                                                            <div><img src="{{asset('images/cart_2.svg')}}"
                                                                                    alt="">
                                                                                <div>+</div>
                                                                            </div>
                                                                        </div>
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-8 offset-sm-2 offset-md-0">
                                                    <div class="product home_item_large">
                                                        ...
                                                        <div class="product_image"><img
                                                                src="{{asset('images/product_1.jpg')}}" alt=""></div>
                                                        <div class="product_content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-8 offset-sm-2 offset-md-0">
                                                    <div class="product home_item_large">
                                                        ...
                                                        <div class="product_image"><img
                                                                src="{{asset('images/product_2.jpg')}}" alt=""></div>
                                                        <div class="product_content">
                                                            <div class="product_buttons">
                                                                <div
                                                                    class="text-right d-flex flex-row align-items-start justify-content-start">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-8 offset-sm-2 offset-md-0">
                                                    <div class="product home_item_large">
                                                        ...
                                                        <div class="product_image"><img
                                                                src="{{asset('images/product_3.jpg')}}" alt=""></div>
                                                        <div class="product_content">
                                                            <div class="product_buttons">
                                                                <div
                                                                    class="text-right d-flex flex-row align-items-start justify-content-start">
